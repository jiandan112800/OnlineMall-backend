...
import com.muzi.entity.OrderItem;
...
import com.muzi.mapper.StandardMapper;
...
public class OrderService extends ServiceImpl<OrderMapper, Order> {
    ...
    public List<Map<String, Object>> selectByCurrentUserAndCondition(String orderNo, String state, String goodName) {
        ...
        if (currentUserId == null) {
            throw new ServiceException(Constants.CODE_401, "未登录或登录已失效");
        }
        ...
        return orderMapper.selectByUserAndCondition(params);
    }
